...
def create_question(question_text, days):
        ...
        the goven number of 'days' offset to now (negative for questions
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of a question with a pu_date in the future
    ...
    def test_past_question(self):
        """
        The detail view of a question with a pub_ate in the past
